...
export default function QuienesSomos() {
  return (
    <div className="container">
      ...
      <div>
        <p className={styles.textoquienessomos}>Nuestro mejor veterinario:</p>
        <img src="/imagenconejo.png" alt="imagen del mejor veterinario" style={{ width: '200px', height:'200px' }}/>
        <Image
      src="/imagenconejo.png"
      width={500}
      height={500}
